...
public class TileLayoutLoader {
    ...
    private static boolean writeLayout(Context context, String layoutText, String indicator) {
        try {
            ...
            System.out.println(context.getDataDir().getAbsolutePath());
