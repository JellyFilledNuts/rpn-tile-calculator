...
public class TileLayoutLoader {
    ...
    public String loadLayout(@NotNull Context context, @NotNull String indicator) {
        ...
        if(indicator.equals("Morestack")) {
            ...
            layout = "S_STACK,1,O_DOUBLE, ;S_STACK,2,O_DOUBLE, ;S_STACK,3,O_DOUBLE, ;A_PLUS,+;A_SIN,sin;H_HISTORY,1,O_DOUBLE, ;H_HISTORY,2,O_DOUBLE, ;H_HISTORY,3,O_DOUBLE, \nO_DOUBLE,1;O_DOUBLE,2;O_DOUBLE,3;A_MINUS,-;A_COS,cos;H_HISTORY,4,O_DOUBLE, ;H_HISTORY,5,O_DOUBLE, ;H_HISTORY,6,O_DOUBLE, \nO_DOUBLE,4;O_DOUBLE,5;O_DOUBLE,6;A_SLASH,/;A_TAN,tan;H_HISTORY,7,O_DOUBLE, ;H_HISTORY,8,O_DOUBLE, ;H_HISTORY,9,O_DOUBLE, \nO_DOUBLE,7;O_DOUBLE,8;O_DOUBLE,9;A_TIMES,*;A_MODULO,%;H_HISTORY,10,O_DOUBLE, ;H_HISTORY,11,O_DOUBLE, ;H_HISTORY,12,O_DOUBLE, \nS_AC,AC;O_DOUBLE,0;S_ENTER,Enter;A_POWER,pow;A_ROOT,root;H_HISTORY,13,O_DOUBLE, ;H_HISTORY,14,O_DOUBLE, ;H_HISTORY,15,O_DOUBLE, \nS_DEL,delete;S_TURNAROUNDSIGN,+/-;S_SWAP,Swap;S_INVERSE,1/x;A_LOG,log;H_HISTORY,16,O_DOUBLE, ;S_LOADLAYOUT,Load;S_SAVELAYOUT,Save";
